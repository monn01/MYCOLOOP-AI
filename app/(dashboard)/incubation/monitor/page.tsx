...
import { INCUBATION_PARAM_CONFIG } from "@/lib/ui/param-configs";
import { PipelineStage } from "@/lib/generated/prisma/enums";

const STAGE = PipelineStage.INCUBATION;

export default function IncubationMonitorPage() {
  ...
  if (!batch) {
    return (
      <div className="rounded-card border border-status-neutral-border bg-status-neutral-bg p-6 text-center">
        ...
        <p className="mt-1 text-sm text-muted-foreground">Monitor akan aktif begitu ada batch Smart Incubation.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 lg:space-y-8">
      ...
      <SensorChart data={readings} paramConfig={INCUBATION_PARAM_CONFIG} />
